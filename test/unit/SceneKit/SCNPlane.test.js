...
import _Data from './_SCNPlaneData'
...
describe('SCNPlane class', () => {

  /*
  UnitTest.classFunctionsDefined(SCNPlane, [
  ])

  UnitTest.functionsDefined(SCNPlane, [
  ])

  UnitTest.classPropertiesDefined(SCNPlane, [
  ])

  UnitTest.propertiesDefined(SCNPlane, [
  ])
  */

  describe('constructor function', () => {
    const shape = new SCNPlane()
