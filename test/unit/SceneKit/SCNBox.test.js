...
describe('SCNBox class', () => {

  /*
  UnitTest.classFunctionsDefined(SCNBox, [
  ])

  UnitTest.functionsDefined(SCNBox, [
  ])

  UnitTest.classPropertiesDefined(SCNBox, [
  ])

  UnitTest.propertiesDefined(SCNBox, [
  ])
  */

  describe('constructor function', () => {
    const shape = new SCNBox()
