...
import _Data from './_SCNCapsuleData'
...
describe('SCNCapsule class', () => {

  /*
  UnitTest.classFunctionsDefined(SCNCapsule, [
  ])

  UnitTest.functionsDefined(SCNCapsule, [
  ])

  UnitTest.classPropertiesDefined(SCNCapsule, [
  ])

  UnitTest.propertiesDefined(SCNCapsule, [
  ])
  */

  describe('constructor function', () => {
    const shape = new SCNCapsule()
