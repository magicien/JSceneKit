...
import _Data from './_SCNConeData'
...
describe('SCNCone class', () => {

  /*
  UnitTest.classFunctionsDefined(SCNCone, [
  ])

  UnitTest.functionsDefined(SCNCone, [
  ])

  UnitTest.classPropertiesDefined(SCNCone, [
  ])

  UnitTest.propertiesDefined(SCNCone, [
  ])
  */

  describe('constructor function', () => {
    const shape = new SCNCone()
