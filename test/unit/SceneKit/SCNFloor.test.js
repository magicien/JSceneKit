...
import _Data from './_SCNFloorData'
...
describe('SCNFloor class', () => {

  /*
  UnitTest.classFunctionsDefined(SCNFloor, [
  ])

  UnitTest.functionsDefined(SCNFloor, [
  ])

  UnitTest.classPropertiesDefined(SCNFloor, [
  ])

  UnitTest.propertiesDefined(SCNFloor, [
  ])
  */

  describe('constructor function', () => {
    const shape = new SCNFloor()
