...
import _Data from './_SCNTubeData'
...
describe('SCNTube class', () => {

  /*
  UnitTest.classFunctionsDefined(SCNTube, [
  ])

  UnitTest.functionsDefined(SCNTube, [
  ])

  UnitTest.classPropertiesDefined(SCNTube, [
  ])

  UnitTest.propertiesDefined(SCNTube, [
  ])
  */

  describe('constructor function', () => {
    const shape = new SCNTube()
